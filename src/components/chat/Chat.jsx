          ...
          {messages.map((msg) => (
            ...
            >
              <div className="flex items-center gap-3">
                {/* Avatar */}
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 text-white flex items-center justify-center font-semibold flex-shrink-0">
                  {msg.avatar}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 truncate">{msg.role}</p>
      ...
      <div className={`${
        ...
        <div className="border-b border-gray-200 p-3 md:p-4 flex items-center justify-between bg-white sticky top-0 z-10">
          <div className="flex items-center gap-2 md:gap-3 min-w-0">
            <button
              ...
              className="md:hidden text-gray-600 flex-shrink-0"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-gray-400 to-gray-600 text-white flex items-center justify-center font-semibold flex-shrink-0 text-sm md:text-base">
        ...
        <div className="border-t border-gray-200 p-3 md:p-4 bg-blue-50">
          <div className="flex items-center gap-2 md:gap-3">
            <button className="text-blue-500 hover:text-blue-600 flex-shrink-0 p-1">
              <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="text-gray-600 hover:text-gray-800 flex-shrink-0 p-1"
            >
              <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
